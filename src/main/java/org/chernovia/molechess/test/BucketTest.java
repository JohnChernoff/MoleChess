...
public class BucketTest {
        ...
        static int[] ratings = { 1260, 790, 1088, 910, 943, 1462, 1454, 1501, 638, 1092 }; //static int[] ratings = { 1260 };
        public static void main(String[] args) {
            MoleUser[] users = new MoleUser[ratings.length];
            for (int i=0;i<ratings.length;i++) {
                users[i] = new MoleUser(null,"","User" + i,ratings[i]); //users[i].setData(0,0,ratings[i],"");
            }
